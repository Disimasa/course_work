...
#include "Layer.h"
/// Класс сверточного слоя нейронной сети. Чаще всего используется для обработки изображений, данная реализация использует valid метод для обработки изображения
